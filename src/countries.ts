...
// Comprehensive list of countries with dial codes & flags
export const COUNTRIES: Country[] = [
  ...
  { name: "Australia", code: "AU", dial: "+61", flag: "🇦🇺", format: "### ### ###" },
  ...
  { name: "France", code: "FR", dial: "+33", flag: "🇫🇷", format: "## ## ## ## ##" },
  { name: "Georgia", code: "GE", dial: "+995", flag: "🇬🇪" },
  { name: "Germany", code: "DE", dial: "+49", flag: "🇩🇪", format: "### #######" },
  ...
  { name: "India", code: "IN", dial: "+91", flag: "🇮🇳", format: "##### #####" },
  { name: "Indonesia", code: "ID", dial: "+62", flag: "🇮🇩" },
  { name: "Iran", code: "IR", dial: "+98", flag: "🇮🇷" },
  { name: "Iraq", code: "IQ", dial: "+964", flag: "🇮🇶" },
  { name: "Ireland", code: "IE", dial: "+353", flag: "🇮🇪" },
  { name: "Israel", code: "IL", dial: "+972", flag: "🇮🇱" },
  { name: "Italy", code: "IT", dial: "+39", flag: "🇮🇹", format: "### ### ####" },
  { name: "Jamaica", code: "JM", dial: "+1", flag: "🇯🇲" },
  { name: "Japan", code: "JP", dial: "+81", flag: "🇯🇵", format: "## #### ####" },
  ...
  { name: "Mexico", code: "MX", dial: "+52", flag: "🇲🇽", format: "### ### ####" },
  ...
  { name: "Pakistan", code: "PK", dial: "+92", flag: "🇵🇰", format: "### #######" },
  ...
  { name: "United Arab Emirates", code: "AE", dial: "+971", flag: "🇦🇪", format: "## ### ####" },
  { name: "United Kingdom", code: "GB", dial: "+44", flag: "🇬🇧", format: "#### ######" },
  { name: "United States", code: "US", dial: "+1", flag: "🇺🇸", format: "(###) ###-####" },
...
// Format phone number using country format string ("(###) ###-####")
...
// Determine max digits for a country (count # in format, or default 15)
export function maxPhoneDigits(format?: string): number {
  if (!format) return 15;
  return (format.match(/#/g) || []).length;
}

// Find by dial code (best match by length, longest dial first)
...
export const DEFAULT_COUNTRY = findCountryByCode("US")!;
